    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white border-end" data-mdb-perfect-scrollbar='true'>
        ...
        <div class="position-sticky">
            <div class="list-group list-group-flush">
                ...
                <a aria-current="true" data-mdb-toggle="collapse" href="#hr" aria-controls="hr" aria-expanded="true" class="list-group-item list-group-item-action py-2 ripple d-flex align-items-center justify-content-between {{ strpos(url()->current(), 'welcome/hr/employee') !== false ? 'bg-warning text-white' : '' }}">
                ...
                <ul id="hr" class="collapse {{ strpos(url()->current(), 'welcome/hr/employee') !== false ? 'show' : '' }} list-group list-group-flush">
                ...
                @if(auth()->user()->role == 1)
                    <a aria-current="true" data-mdb-toggle="collapse" href="#leave" aria-controls="leave" aria-expanded="true" class="list-group-item list-group-item-action py-2 ripple d-flex align-items-center justify-content-between {{ strpos(url()->current(), 'welcome/hr/leave') !== false ? 'bg-warning text-white' : '' }}">
                        <div class="d-flex align-items-center">
                    ...
                    <ul id="leave" class="collapse {{ strpos(url()->current(), 'welcome/hr/leave') !== false ? 'show' : '' }} list-group list-group-flush">
...
<script>
    $(document).ready(function() {
        ...
        $('.list-group-item[data-mdb-toggle="collapse"]').on('click', function() {
