    ...
    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white border-end" data-mdb-perfect-scrollbar='true'>
		...
		<div class="position-sticky">
        	<div class="list-group list-group-flush">
                <a href="/welcome/mayor/dashboard" class="list-group-item list-group-item-action py-2 ripple d-flex align-items-center {{ Request::is('welcome/mayor/dashboard') ? 'bg-warning text-white' : '' }}">
                    <span class="material-icons-outlined pe-2">dashboard</span>
                    <font class="pt-1">Dashboard</font>
                </a>

                <a href="/welcome/mayor/employee" class="list-group-item list-group-item-action py-2 ripple d-flex align-items-center {{ strpos(url()->current(), 'welcome/mayor/employee') !== false ? 'bg-warning text-white' : '' }}">
                    <span class="material-icons-outlined pe-2">group</span>
                    <font class="pt-1">Employee</font>
                </a>

                <a aria-current="true" href="#leave" aria-controls="leave" aria-expanded="true" class="list-group-item list-group-item-action py-2 ripple d-flex align-items-center justify-content-between {{ strpos(url()->current(), 'welcome/mayor/leave') !== false ? 'bg-warning text-white' : '' }}">
                ...
                <ul id="leave" class=" {{ strpos(url()->current(), 'welcome/mayor/leave') !== false ? 'show' : '' }} list-group list-group-flush">
                    <a href="/welcome/mayor/leave/received" class="list-group-item border-bottom list-group-item-action py-2 ripple d-flex align-items-center {{ Request::is('welcome/mayor/leave/received') ? 'menu-active2' : '' }}">
                        <span class="material-icons-outlined pe-2">call_received</span>
                        <font class="pt-1">Received</font>
                    </a>

                    <a href="/welcome/mayor/leave/managed" class="list-group-item border-bottom list-group-item-action py-2 ripple d-flex align-items-center {{ Request::is('welcome/mayor/leave/managed') ? 'menu-active2' : '' }}">
	          		...
	          		<div class="d-flex align-items-center">
						<a class="nav-link dropdown-toggle text-dark d-flex align-items-center" href="#" id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
	          			...
	          			<ul class="dropdown-menu dropdown-menu-end rounded-0 border" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li>
			              		<a class="dropdown-item rounded-0 d-flex align-items-center" href="/welcome/mayor/account-settings">
